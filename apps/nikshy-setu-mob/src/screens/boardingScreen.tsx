...
const onProgressSteps = {
    ...
    "0.2": {
        chatBotText: "Please enter your mobile number below. We'll send you an OTP to verify your number. 📲 ",
        buttonTxt: "Verify     ❯",
        animationSpeed: 40
    },
    "0.4": {
        ...
        <ScreenContainer style={{ paddingHorizontal: 20, }} >
            <View style={{ flex: 0.2, }}>
                <Row style={{ backgroundColor: '#F4FFFF' }}>
                    ...
                    <Column style={{ justifyContent: "center", flex: 1 }}>
                        {values.progress === 0.1 && <Text style={styles1.typingText}>Hi! 😊</Text>}
                        <TypingText
            ...
            {values.progress === 0.1 &&
                <View style={{ flex: 1, justifyContent: 'center', }}>
                    ...
                    />
                    {values.isNumOrEmail === "Email" ? <InputText
                        label={"Email Address"}
            ...
            <View style={{ flex: 0.2, justifyContent: 'center' }}>
                <Button bgColor="#394F89" title={onProgressSteps[values.progress].buttonTxt} onPress={() => {
                    setValues({ ...values, progress: values.progress === 0.1 ? 0.2 : values.progress === 0.2 ? 0.4 : 0.5 })
                }} />
            </View>
        </ScreenContainer>)
};
